...
class admin extends spController{
	public function __construct(){
        ...
        public function updateRank(){
            spClass('m_pro')->runSql('update fstk_pro set rank=500 where iid in (select t.iid from (select iid from fstk_pro where rank=499 and st<=curdate() and et>=curdate() and ischeck=1 and type!=87 and classification=1 order by rank asc,postdt desc limit 112,18446744073709551615)as t)');
        }
