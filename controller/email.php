...
class email extends spController{
	...
	public function sendemail($smtpemailto,$mailsubject,$mailbody){
		...
		$smtpemailto = $this->spArgs("smtpemailto")?$this->spArgs("smtpemailto"):"247176039@qq.com";//发送给谁
		$mailsubject = $this->spArgs("mailsubject")?$this->spArgs("mailsubject"):"一秒疯抢根据您的偏好【精选多款单品】任您选！";//邮件主题
		$mailbody =  $this->spArgs("mailbody")?$this->spArgs("mailbody"):$this->mailbody;//邮件内容
